...
$.ajax({
  ...
  success: function(data) {
  			console.log(data);
  			if(data.success){
          var str="<thead><tr><th>name</th><th>Submitted Team for approval</th><th>Members</th><th>Submit your team</th><th>Approval Status</th><th>Comments</th></tr></thead><tbody>";
